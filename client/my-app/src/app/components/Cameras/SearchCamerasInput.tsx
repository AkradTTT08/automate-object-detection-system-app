...
export default function SearchCamerasInput() {
  ...
  // sync ค่าจากแถบที่อยู่ (กรณี user กด back/forward)
  useEffect(() => {
    const q = searchParams.get("q") ?? "";
    ...
    <div className="relative w-full">
      <div className="flex items-center gap-2 w-full rounded-md border border-[var(--color-primary-bg)] px-3 py-2 focus-within:ring focus-within:ring-[var(--color-primary)] bg-white">
        ...
        <input
          ...
          placeholder='Search cameras (e.g. "12", "library", "id:5", "location:lobby")'
