...
import NotificationModal from '@/app/components/Utilities/CameraAlertsModal';
            ...
            <Table className="table-auto w-full">
                <TableHeader>
                    <TableRow className="border-b border-[var(--color-primary)]">
                        ...
                        <TableHead className="text-[var(--color-primary)]">Alerts</TableHead>
                                ...
                                <TableCell className="min-w-[220px]">
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <IconAction
                                            ...
                                            onClick={() => {
                                                setSelectedCameraName(cam.camera_name); // ส่งชื่อกล้อง
                                                setOpen(true);
                                            }}
                                        >
